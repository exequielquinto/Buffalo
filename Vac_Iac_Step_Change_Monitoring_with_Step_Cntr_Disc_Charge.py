...
def measure():
    ...
    temp['110_Iac_External'] = Iac_External
...
#while temp['103_State'] !=10:# or stp_ctr!=10):
while temp['118_SOC']>5:
    ...
    if (temp['109_Vac_Grid_L2L']-Prev_Vac)>10:
        stp_ctr=stp_ctr+1
        temp['122_Vac_Step_Cntr']=stp_ctr
        print stp_ctr
    ...
    print temp['103_State'], temp['105_Permissive_Data'],temp['104_Permissive'], temp['121_Permissive_Code'], temp['120_Fault_Code'], temp['108_Watts_Inverter'], temp['109_Vac_Grid_L2L'], temp['106_Inv_AC_Voltage'], temp['118_SOC']
    results.to_csv('70eg_1k5W_Discharge_85_400_10_10VStep.csv') 
    #time.sleep(1)
...
fid = open('Unit3_1k5W_DisCharge_70deg_10VStep'+'.png','wb')
fid.write(raw_data)
fid.close()
...
while temp['118_SOC']<95:# !=10:# or stp_ctr!=10):
    ...
    results = results.append(temp, ignore_index=True)    # 17
    print temp['103_State'], temp['105_Permissive_Data'],temp['104_Permissive'], temp['121_Permissive_Code'], temp['120_Fault_Code'], temp['108_Watts_Inverter'], temp['109_Vac_Grid_L2L'], temp['106_Inv_AC_Voltage'], temp['118_SOC']
    results.to_csv('70deg_1k5W_Charge_85_400_10_Unit3_10VStep.csv') 
    #time.sleep(1)
...
scope.write('HARDCOPY START')
raw_data = scope.read_raw()
fid = open('Unit3_1k5W_Charge_70deg_10VStep'+'.png','wb')
fid.write(raw_data)
fid.close()
